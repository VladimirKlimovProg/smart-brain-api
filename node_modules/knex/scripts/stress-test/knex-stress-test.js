...
const pg = Knex({
  client: 'pg',
  connection: '***REMOVED***://***REMOVED***:***REMOVED***rootpassword@localhost:25432/***REMOVED***',
  pool: { max: 50 }
});
...
async function killConnectionsPg() {
  return pg.raw(`SELECT pg_terminate_backend(pg_stat_activity.pid) 
    ...
    WHERE pg_stat_activity.datname = '***REMOVED***' 
...
async function main() {
  ...
  async function recreateProxies() {
    await recreateProxy('***REMOVED***ql', 25432, 5432);
