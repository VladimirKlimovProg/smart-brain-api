...
test('using connection string in client constructor', function(t){
  var subject = parse('***REMOVED***://brian:pw@boom:381/lala');
...
test('escape spaces if present', function(t){
  var subject = parse('***REMOVED***://localhost/post gres');
  t.equal(subject.database, 'post gres');
  t.end();
});

test('do not double escape spaces', function(t){
  var subject = parse('***REMOVED***://localhost/post%20gres');
  t.equal(subject.database, 'post gres');
  t.end();
});
...
test('password contains  < and/or >  characters', function(t){
  ...
  var connectionString = '***REMOVED***://' + sourceConfig.user + ':' + sourceConfig.password + '@' + sourceConfig.host + ':' + sourceConfig.port + '/' + sourceConfig.database;
